...
if (isset($_REQUEST['update'])) {
    ...
    $facility1 = isset($_POST['facility1']) ? $_POST['facility1'] : null;
    $facility2 = isset($_POST['facility2']) ? $_POST['facility2'] : null;
    $facility3 = isset($_POST['facility3']) ? $_POST['facility3'] : null;
    $facility4 = isset($_POST['facility4']) ? $_POST['facility4'] : null;
    $facility5 = isset($_POST['facility5']) ? $_POST['facility5'] : null;
    $facility6 = isset($_POST['facility6']) ? $_POST['facility6'] : null;
    $facility7 = isset($_POST['facility7']) ? $_POST['facility7'] : null;
    $facility8 = isset($_POST['facility8']) ? $_POST['facility8'] : null;
